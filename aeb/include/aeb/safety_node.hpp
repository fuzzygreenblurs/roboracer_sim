...
private:
  ...
  static bool enable_aeb_;  

	static constexpr double EPSILON = 0.0001f;	
	static constexpr size_t BEAM_COUNT = 1080;
	static constexpr float AEB_MIN_RADIUS = 5;

	static constexpr const char* SCAN_TOPIC = "autodrive/roboracer_1/lidar";
  static constexpr const char* SPEED_TOPIC = "autodrive/roboracer_1/speed";
  static constexpr const char* HEADING_TOPIC = "autodrive/roboracer_1/imu";
	static constexpr const char* THROTTLE_CMD_TOPIC = "/autodrive/roboracer_1/throttle_command";
	static constexpr const char* THROTTLE_CMD_RAW_TOPIC = "/autodrive/roboracer_1/throttle_command_raw";
